...
import { Lock, Mic, MicOff, Radio, Unlock, Volume2 } from "lucide-react";

export default function PushToTalk({ active, compact, locked, muted, disabled, onStart, onStop, onToggleLock, onToggleSpeaker }) {
